...
describe ("Clase Enemy",function(){
	...
	it("Creando enemigos",function(){
		...
		var enemy1 = new Enemy({x: 100, y: -50, sprite: 'enemy_purple', B: 100, C: 4, E: 100, health: 20});
		var enemy2 = new Enemy({x: 100, y: -50, sprite: 'enemy_purple', B: 100, C: 4, E: 100, health: 20},{x: 200});
	...
	it ("step",function(){
		SpriteSheet = {map: {enemy_purple: { sx: 37, sy: 0, w: 42, h: 43, frames: 1 }}};
		var enemy = new Enemy({x: 100, y: -50, sprite: 'enemy_purple', B: 100, C: 4, E: 100, health: 20});
